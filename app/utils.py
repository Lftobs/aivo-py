...
DO NOT ADD ANY INTRO TEXT IN YOUR RESPONSE LIKE "Here's a summary of the provided text:" ONLY RESPOND WITH TASK GIVEN.....YOU RESPONSE SHOULD STRICTLY  FOLLOW THIS EXAMPLE FORMAT:
...
def extract_segments(text):
    ...
    # Pattern to capture the Overview Summary text
